...
def all_supplies_in_holidays(holiday_hash)
  ...
  holiday_hash.each do |season, holidays_hash|
    ...
    holidays_hash.each do |holiday, supplies_array|
      ...
      capital_holiday = holiday_name.collect {|word| word.capitalize}
      puts "  #{capital_holiday.join(" ")}: #{supplies_array.join(", ")}"
    end
  end
...
def all_holidays_with_bbq(holiday_hash)
  ...
  holiday_hash.collect do |season, holidays_hash|
    holidays_hash.collect do |holiday, supplies_array|
      bbq_holiday << holiday if supplies_array.include?("BBQ")
    end
  end
  bbq_holiday
end
